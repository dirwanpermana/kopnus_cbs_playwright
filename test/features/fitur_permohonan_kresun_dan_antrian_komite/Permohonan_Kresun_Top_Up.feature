...
@topup_kresun @regression
  Scenario: Mengajukan Permohonan kresun pada cbs konven
    ...
    When Pengguna menginput nomor pensiun yang valid dan mengisi form permohonan "top up"
    When Pengguna Logout dari cbs
    # And inject nopen ke database Permohonan NOPEN KYO6486316829 berhasil disimpan
