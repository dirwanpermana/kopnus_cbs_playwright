...
- Name: test/features/fitur_permohonan_kresun_dan_antrian_komite/AntrianKomite.feature.spec.js >> Antrian Komite >> Verifikasi Antrian Komite
- Location: .features-gen/test/features/fitur_permohonan_kresun_dan_antrian_komite/AntrianKomite.feature.spec.js:6:7

# Error details

```
Error: Test data 'userPusat' tidak ditemukan di loginData.json
```
...
- generic [ref=e3]:
  ...
  - generic [ref=e26]:
    - generic [ref=e27]:
      - paragraph [ref=e28]: All in One Place, Transaction
